...
// Rental Activity 1 Again
 class Rental {
    constructor(nameStore, address, tel, moviesAvailable) {
        this.nameStore = nameStore;
        this.address = address;
        this.tel = tel;
        this.moviesAvailable = moviesAvailable;

        const whichAvailable = {
            movie1: "Pineapple Express",
            movie2: "i Robot",
            movie3: "Die Hard",
            movie4: "John Wick",
            movie5: "Tropical Thunder"
         } 
    }
 }

 const test = new Rental("MCR Rental", "Manchester", "01617489478", 1);
 console.log(test);